...
if not ConVarExists( "npcg_accuracy_marksiltanen" ) then CreateConVar( "npcg_accuracy_marksiltanen" , "2" , { FCVAR_REPLICATED , FCVAR_ARCHIVE } ) end

ENT.Type = "anim"
ENT.Base = "base_anim"
ENT.PrintName = "Mark Siltanen Enemy"
ENT.Author = "V92"
ENT.Information = ""
...
-- local WeaponTbl = { "weapon_shotgun" }
...
if SERVER then
	...
	function ENT:Initialize( )
		...
		self.ent1:SetModel( Model( "models/jessev92/characters/highvis/mark/npccmb.mdl") )
		...
		self.ent1:SetKeyValue( "Expression Type" , "Angry" )
		self.ent1:SetKeyValue( "NumGrenades" , ( GetConVarNumber( "npcg_grenadecount" ) or 5 ) )
		...
		if GetConVarNumber( "npcg_squad_marksiltanen" ) != 0 then
			self.ent1:SetKeyValue( "SquadName", "INFRA-Enemy" )
		end
